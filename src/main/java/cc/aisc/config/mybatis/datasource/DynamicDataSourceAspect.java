package cc.aisc.config.mybatis.datasource;

import cc.aisc.config.mybatis.datasource.annotation.TargetDataSource;
...
public class DynamicDataSourceAspect {
    ...
    @Pointcut("@annotation(cc.aisc.config.mybatis.datasource.annotation.TargetDataSource)")
    public void targetDataSource(){}

    @Pointcut("execution(* cc.aisc.business.service.*.*(..))")
    public void exec(){}

    @Pointcut("execution(* cc.aisc.business.*.findBy*(..))")
    public void findBy(){}
