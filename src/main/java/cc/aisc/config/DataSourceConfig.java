...
import cc.aisc.config.mybatis.datasource.DynamicDataSource;
...
@MapperScan(basePackages = {"cc.aisc.business.mybatis.mapper"}, sqlSessionFactoryRef = "sqlSessionFactory")
public class DataSourceConfig implements TransactionManagementConfigurer {
    ...
    public SqlSessionFactory sqlSessionFactoryBean() {
        try {
            ...
            sqlSessionFactoryBean.setTypeAliasesPackage("cc.aisc.business.model");
